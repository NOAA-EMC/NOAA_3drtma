...
#${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfprs_subhralaska_${FCST_TIME}.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfprs_${basetime}${FCST_TIME}00
#${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrftwo_subhralaska_${FCST_TIME}.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrftwo_${basetime}${FCST_TIME}00
#${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfnat_subhralaska_${FCST_TIME}.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfnat_${basetime}${FCST_TIME}00
