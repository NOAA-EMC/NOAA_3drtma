...
${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfprs_subhrconus_${FCST_TIME}.grib2 ${COMIN}/${PROD_HEAD}.wrfprs_subhrconus_${FCST_TIME}.grib2
${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrfnat_subhrconus_${FCST_TIME}.grib2 ${COMIN}/${PROD_HEAD}.wrfnat_subhrconus_${FCST_TIME}.grib2
${LN} -sf ${COMOUTpost_rtma3d}/${PROD_HEAD}.wrftwo_subhrconus_${FCST_TIME}.grib2 ${COMIN}/${PROD_HEAD}.wrftwo_subhrconus_${FCST_TIME}.grib2
