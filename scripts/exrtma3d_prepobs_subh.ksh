...
# prepbufr obs
if [ -r ${COMINrap}/newgblav.${YYYYMMDD}.rap.t${HH}${mm}z.prepbufr ] ; then
  cpreq ${COMINrap}/newgblav.${YYYYMMDD}.rap.t${HH}${mm}z.prepbufr                 ${COMINobsproc_rtma3d}/newgblav.${YYYYMMDD}.rap.t${HH}${mm}z.prepbufr
  ${LN} -sf ${COMINobsproc_rtma3d}/newgblav.${YYYYMMDD}.rap.t${HH}${mm}z.prepbufr  ${DATA}/newgblav.${YYYYMMDD}.rap.t${HH}${mm}z.prepbufr
elif [ -f ${COMINrap}/rap.t${HH}${mm}z.prepbufr.tm00 ] ; then
  cpreq ${COMINrap}/rap.t${HH}${mm}z.prepbufr.tm00                   ${COMINobsproc_rtma3d}/rap.t${HH}${mm}z.prepbufr.tm00
  ${LN} -sf ${COMINobsproc_rtma3d}/rap.t${HH}${mm}z.prepbufr.tm00    ${DATA}/rap.t${HH}${mm}z.prepbufr.tm00
else
  ${ECHO} "Warning: ${COMINrap}/rap.t${HH}${mm}z.prepbufr.tm00 does NOT exist! "
fi
