...
elif [ "${envir}" == "lsf" ]; then #wcoss expr runs
...
elif [ -r "${OBS_DIR}/rtma_ru.${tz_str}.prepbufr.tm00" ]; then
  ${LN} -sf ${OBS_DIR}/rtma_ru.${tz_str}.prepbufr.tm00 ./prepbufr
else
...
${CP} ${PARMgsi}/gsiparm.anl.sh_ns gsiparm.anl.sh
