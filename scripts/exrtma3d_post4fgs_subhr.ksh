...
${CP} ${workdir}/wrfsubhprs_fgs.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD2}.wrfsubhprs_fgs.grib2
${CP} ${workdir}/wrfsubhspl_fgs.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD2}.wrfsubhspl_fgs.grib2
${CP} ${workdir}/wrfsubhnat_fgs.grib2 ${COMOUTpost_rtma3d}/${PROD_HEAD2}.wrfsubhnat_fgs.grib2
