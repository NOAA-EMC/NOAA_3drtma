...
#    NOTE 2: A imum of one grid for each domain (CONUS/HI/PR/AK) may be specified in $1.  Examples of grid combinations
...
#-set_byte 4 47 3 ensures we are dealing with minimum value
