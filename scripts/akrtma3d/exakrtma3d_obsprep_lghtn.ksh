...
# WPS GEO_GRID Data
${LN} -s ${FIXwps}/hrrr_geo_em.d01.nc_AK           ./geo_em.d01.nc 
...
cpreq -p ${DATA}/${NET}.t${cyc}z.lghtng.tm00.bufr_d ${COMINobsproc_rtma3d}
...
cpreq -p ${DATA}/LightningInGSI.bufr ${DATA}/LightningInGSI_bufr.bufr
