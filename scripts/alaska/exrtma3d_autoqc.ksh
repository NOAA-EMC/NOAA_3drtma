...
if [ ${HH} -eq 23 ]; then
  ...
  python ${NWROOT}/ush/aircraft_reject_lists.py ${RUN}ak ${startcyc_aircraft} ${YYYYMMDDHH} ${DATA} ${COMOUTautoqc_rtma3d} ${PDYprev_aircraft_dir} ${PDYprev_aircraft} ${EXECrtma3d}/${NET}_read_diag ${dom}
