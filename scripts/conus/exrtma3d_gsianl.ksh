...
cpreq -p ${FIXgsi}/rtma3d_conus_terrain.dat          ./rtma_terrain.dat
cpreq -p ${FIXgsi}/rtma3d_conus_anl_slmask.dat       ./rtma_slmask.dat
# cpreq -p ${FIXgsi}/valley_map_hrrr_conus_bin.dat   ./valley_map.dat
  cpreq -p ${FIXgsi}/valley_map_hrrr_conus_ieee.dat  ./valley_map.dat

# Copy MESONET wind observation sensor height list (same as used in 2DRTMA)
  [[ -f ./provider_windheight ]] && rm ./provider_windheight
  cpreq -p ${FIXgsi}/rtma3d_conus_provider_windheight  ./provider_windheight
