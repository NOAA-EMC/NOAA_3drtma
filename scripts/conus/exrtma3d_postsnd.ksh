...
cpreq ${PARMrtma3d}/${RUN}_bufr.tbl .
cpreq ${PARMrtma3d}/${RUN}_modtop.parm .
cpreq ${PARMrtma3d}/${RUN}_sndp.parm.mono sndp.parm
...
${EXECrtma3d}/${pgm} < ${RUN}_modtop.parm  > sndp.out
export err=$?; err_chk

if [ $SENDCOM == "YES" ]; then
  cpreq class1.bufr ${COMOUT}/${RUN}.t${cyc}z.class1.bufr
  cpreq profilm.c1.${tmmark} ${COMOUT}/${RUN}.t${cyc}z.profilm.c1
fi
...
cpreq ../hrrr.${cyc}.bufrsnd.tar.gz $COMOUT/${RUN}.t${cyc}z.bufrsnd.tar.gz
