...
cpreq ${FIXrtma3d}/${RUN}_hrrr_profdat .
...
cp ${COMIN}/${RUN}.t${cyc}z.wrf_inout.nc wrfoutd01_${timeform}
cp ${COMINm1}/${RUN}.t${ohr}z.wrf_inout.nc wrfoutd01_${timeformold}
...
ln -sf itag              fort.11
ln -sf ${RUN}_hrrr_profdat  fort.19
