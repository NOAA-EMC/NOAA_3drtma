...
if [ ! ${DATAWRFFILE} ]; then
  ${ECHO} "ERROR: DATAWRFFILE, \$DATAWRFFILE, is not defined"
  exit 1
fi
...
${CAT} ${workdir}/WRFPRS.GrbF${FCST_TIME01} ${workdir}/WRFTWO.GrbF${FCST_TIME01} > ${workdir}/WRFPRS.GrbF${FCST_TIME01}.new
${MV} ${workdir}/WRFPRS.GrbF${FCST_TIME01}.new ${workdir}/wrfprs_${POST_NAME}_${FCST_TIME}.grib2

# Append entire wrftwo to wrfnat
${CAT} WRFNAT.GrbF${FCST_TIME01} WRFTWO.GrbF${FCST_TIME01} > ${workdir}/WRFNAT.GrbF${FCST_TIME01}.new
${MV} WRFNAT.GrbF${FCST_TIME01}.new ${workdir}/wrfnat_${POST_NAME}_${FCST_TIME}.grib2

${MV} ${workdir}/WRFTWO.GrbF${FCST_TIME01} ${workdir}/wrftwo_${POST_NAME}_${FCST_TIME}.grib2
