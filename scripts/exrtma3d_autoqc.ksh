...
while [ ${i} -lt ${max_cycs} ]; do
  ...
  #probe_dir=${COMOUTautoqc_rtma3d}/../../rtma3d.${probe_YYYYMMDD}/autoqcprd.t${probe_HH}${probe_MM}z # NOT WORKING - can it be fixed?
...
python ${NWROOT}/sorc/rtma_autoqc.fd/gen_database_autoqc.py ${YYYYMMDDHHMM} ${DATA} ${COMOUTautoqc_rtma3d} ${PDYprev_dir}
