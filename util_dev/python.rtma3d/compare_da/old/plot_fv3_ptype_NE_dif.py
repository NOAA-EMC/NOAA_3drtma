...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=42.0,lon_0=-80.0,\
                  llcrnrlat=40.5,urcrnrlat=47.5,llcrnrlon=-80.0,urcrnrlon=-66.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_NE_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
