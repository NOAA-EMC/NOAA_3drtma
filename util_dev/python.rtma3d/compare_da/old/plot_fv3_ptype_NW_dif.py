...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=44.0,lon_0=-116.0,\
                  llcrnrlat=40.5,urcrnrlat=49.5,llcrnrlon=-125.5,urcrnrlon=-109.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_NW_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
