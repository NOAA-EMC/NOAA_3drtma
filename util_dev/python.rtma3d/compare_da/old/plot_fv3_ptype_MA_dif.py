...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=37.5,lon_0=-80.0,\
                  llcrnrlat=36.5,urcrnrlat=42.0,llcrnrlon=-82.0,urcrnrlon=-73.5,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_MA_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
