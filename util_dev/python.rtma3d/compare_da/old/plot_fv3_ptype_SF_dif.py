...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=37.5,lon_0=-121.0,\
                  llcrnrlat=37.25,urcrnrlat=38.5,llcrnrlon=-123.25,urcrnrlon=-121.25,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_SF_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
