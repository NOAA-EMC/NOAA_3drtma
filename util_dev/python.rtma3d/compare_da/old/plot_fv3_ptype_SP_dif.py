...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=46.0,lon_0=-120.0,\
                  llcrnrlat=45.0,urcrnrlat=49.2,llcrnrlon=-125.0,urcrnrlon=-119.5,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_SP_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
