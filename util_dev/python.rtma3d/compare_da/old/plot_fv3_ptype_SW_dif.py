...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=37.0,lon_0=-113.0,\
                  llcrnrlat=30.0,urcrnrlat=42.5,llcrnrlon=-125.0,urcrnrlon=-108.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_SW_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
