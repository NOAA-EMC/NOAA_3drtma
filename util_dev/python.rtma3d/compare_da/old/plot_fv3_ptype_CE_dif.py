...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=35.0,lon_0=-97.0,\
                  llcrnrlat=32.5,urcrnrlat=41.5,llcrnrlon=-103.0,urcrnrlon=-88.5,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_CE_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
