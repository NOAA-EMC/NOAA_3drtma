...
#rocotocheck -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.db -c 2020008041200  -t makeplots_obs

#rocotostat -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.db 
...
#rocotorun -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.db
rocotocheck  -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_obs.db -c 202008041200 -t makeplots_obs
