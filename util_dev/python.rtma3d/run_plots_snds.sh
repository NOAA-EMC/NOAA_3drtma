...
rocotoboot -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_snds.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_snds.db -c 202005151200 -t profile
#rocotorun -v 10 -w /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_snds.xml -d /gpfs/dell2/emc/modeling/noscrub/Edward.Colon/python.rtma3d/drive_plots_snds.db
