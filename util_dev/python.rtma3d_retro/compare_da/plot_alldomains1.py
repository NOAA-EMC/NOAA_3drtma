...
data2 = pygrib.open('/gpfs/dell2/stmp/Edward.Colon/rtma3d_wrkdir_realtime/com2/rtma3d/lsf/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhprs.grib2')
data1 = pygrib.open('/gpfs/dell2/stmp/Edward.Colon/rtma3d_wrkdir_realtime/com2/rtma3d/lsf/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhprs_fgs.grib2')

print(('/gpfs/dell2/stmp/Edward.Colon/rtma3d_wrkdir_realtime/com2/rtma3d/lsf/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'00z/rtma3d.t'+cyc+subcyc+'00z.wrfsubhprs.grib2'))
print(('/gpfs/dell2/stmp/Edward.Colon/rtma3d_wrkdir_realtime/com2/rtma3d/lsf/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'00z/rtma3d.t'+cyc+subcyc+'00z.wrfsubhprs_fgs.grib2'))
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.05,'3D-RTMA FGS MUCAPE (shaded) and MUCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
      ...
      ax.text(.5,1.05,'3D-RTMA ANL MUCAPE (shaded) and MUCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.05,'3D-RTMA FGS SFCAPE (shaded) and SFCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
      ...
      ax.text(.5,1.05,'3D-RTMA ANL SFCAPE (shaded) and SFCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.05,'3D-RTMA FGS MLCAPE (shaded) and MLCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
      ...
      ax.text(.5,1.05,'3D-RTMA ANL MLCAPE (shaded) and MLCIN (hatched) ('+units+') \n <-500 (*), -500<-250 (+), -250<-100 (/), -100<-25 (.) \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#      cbar3.remove()
#      cbar3 = m.colorbar(cs,ax=ax,location='bottom',pad=0.05)
#      cbar3.set_label(units_dif,fontsize=6) 
#      cbar3.ax.tick_params(labelsize=6)
...
#  clevsdif = [20,1000]
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.set_label(units,fontsize=6)
      cbar1.ax.tick_params(labelsize=6)
      ax.text(.5,1.03,'3D-RTMA FGS -10''\xb0''C Reflectivity ('+units+') \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
      ...
      cbar2.set_label(units,fontsize=6)
      cbar2.ax.tick_params(labelsize=6)
      ax.text(.5,1.03,'3D-RTMA ANL -10''\xb0''C Reflectivity ('+units+') \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
      ...
      cbar3.set_label(units,fontsize=6)
      cbar3.ax.tick_params(labelsize=6)
      ax.text(.5,1.03,'3D-RTMA ANL - 3D-RTMA FGS -10''\xb0''C Reflectivity ('+units+') \n valid: '+vtime,horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
