...
data2 = pygrib.open(comrtma3d+'/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhnat.grib2')
data1 = pygrib.open(comrtma3d+'/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhnat_fgs.grib2')
