...
data2 = pygrib.open(comrtma3d+'/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhprs.grib2')
data1 = pygrib.open(comrtma3d+'/rtma3d.'+str(ymd)+'/postprd.t'+cyc+subcyc+'z/rtma3d.t'+cyc+subcyc+'z.wrfsubhprs_fgs.grib2')
...
if graph_option == graph_a:
	domains = ['conus','BN','CE','CO','LA','MA','NC','NE','NW','OV','SC','SE','SF','SP','SW','UM','custom']
