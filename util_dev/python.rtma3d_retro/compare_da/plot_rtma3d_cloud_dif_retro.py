...
#graph_option = str(sys.argv[2])
#llcrnrlon1 = str(sys.argv[3])
#llcrnrlat1 = str(sys.argv[4])
#urcrnrlon1 = str(sys.argv[5])
#urcrnrlat1 = str(sys.argv[6])
#lat_01 =  str(sys.argv[7])
#lon_01 =  str(sys.argv[8])
#xscale1 = str(sys.argv[9])
#yscale1 = str(sys.argv[10])
