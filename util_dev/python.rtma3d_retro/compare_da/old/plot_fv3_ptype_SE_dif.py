...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=34.0,lon_0=-85.0,\
                  llcrnrlat=24.0,urcrnrlat=36.5,llcrnrlon=-91.5,urcrnrlon=-74.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_SE_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
