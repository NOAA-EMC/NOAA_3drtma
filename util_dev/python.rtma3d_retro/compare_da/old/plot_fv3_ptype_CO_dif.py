...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=38.0,lon_0=-105.0,\
                  llcrnrlat=35.0,urcrnrlat=42.0,llcrnrlon=-110.5,urcrnrlon=-100.5,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_CO_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
