...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=38.0,lon_0=-87.0,\
                  llcrnrlat=34.75,urcrnrlat=43.0,llcrnrlon=-91.5,urcrnrlon=-80.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_OV_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
