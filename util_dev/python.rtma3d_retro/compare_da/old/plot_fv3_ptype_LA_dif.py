...
#  else:
  ...
  for ax in axes:
    print ll
    map = Basemap(ax=ax,projection='stere',lat_0=34.0,lon_0=-114.0,\
                  llcrnrlat=32.0,urcrnrlat=37.0,llcrnrlon=-121.0,urcrnrlon=-114.0,\
                  resolution='l')
    x,y=map(lons,lats)
...
#  plt.tight_layout()
  plt.savefig('comparetype_LA_f'+fhr+'.png', bbox_inches='tight',dpi=150)
  plt.close()
