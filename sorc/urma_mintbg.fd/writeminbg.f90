subroutine readminb(nx,ny,hours,threehours,dname,fnum,bnum)
  ...
  if (dname.eq."urma2p5".and.nx.eq.2145.and.ny.eq.1597) then
     open(11,file="conus2p5tz.bin",form="unformatted") !time zone file
     read(11) tzsec
     close(11)
  elseif (dname.eq."urma2p5".and.nx.eq.2345.and.ny.eq.1597) then
     open(11,file="conus2p5exttz.bin",form="unformatted") !time zone file
     read(11) tzsec
     close(11)
  elseif (dname.eq."urma2p5".and.nx.eq.2145.and.ny.eq.1377) then
     open(11,file="conus2p5tz_ndfdonly.bin",form="unformatted") !time zone file
     read(11) tzsec
     close(11)
  elseif (dname.eq."urma2p5".and.nx.eq.1799.and.ny.eq.1059) then
     open(11,file="conus2p5tz_ndfdonly.bin",form="unformatted") !time zone file
     read(11) tzsec
     close(11)
