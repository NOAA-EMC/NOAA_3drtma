...
integer :: history_interval2
integer :: history_interval_change
...
logical :: debug_chem
integer :: simple_dir_fdb
integer :: simple_ind_fdb
integer :: lnox_opt
...
real ,DIMENSION(:,:) ,POINTER :: th2_alt
real ,DIMENSION(:,:) ,POINTER :: t2_alt
real ,DIMENSION(:,:) ,POINTER :: q2_alt
real ,DIMENSION(:,:) ,POINTER :: u10
real ,DIMENSION(:,:) ,POINTER :: v10
real ,DIMENSION(:,:) ,POINTER :: wspd10
real ,DIMENSION(:,:) ,POINTER :: wspd80
...
real ,DIMENSION(:,:,:) ,POINTER :: dfi_frain
real ,DIMENSION(:,:,:) ,POINTER :: dfi_acfrain
...
real ,DIMENSION(:,:) ,POINTER :: acgraup
real ,DIMENSION(:,:) ,POINTER :: acrunoff
real ,DIMENSION(:,:) ,POINTER :: acsnom
real ,DIMENSION(:,:) ,POINTER :: acfrain
...
real ,DIMENSION(:,:,:) ,POINTER :: dfi_tten_rad_1
real ,DIMENSION(:,:,:) ,POINTER :: dfi_tten_rad_2
real ,DIMENSION(:,:,:) ,POINTER :: dfi_tten_rad_3
real ,DIMENSION(:,:,:) ,POINTER :: dfi_tten_rad_4
real ,DIMENSION(:) ,POINTER :: tten_times
...
real ,DIMENSION(:,:) ,POINTER :: hfx_sea
real ,DIMENSION(:,:) ,POINTER :: qfx_sea
real ,DIMENSION(:,:) ,POINTER :: lh_sea
real ,DIMENSION(:,:) ,POINTER :: qsfc_sea
real ,DIMENSION(:,:) ,POINTER :: tsk_sea
real ,DIMENSION(:,:) ,POINTER :: znt_sea
real ,DIMENSION(:,:) ,POINTER :: chs_sea
real ,DIMENSION(:,:) ,POINTER :: chs2_sea
real ,DIMENSION(:,:) ,POINTER :: cqs2_sea
real ,DIMENSION(:,:) ,POINTER :: cpm_sea
real ,DIMENSION(:,:) ,POINTER :: flhc_sea
real ,DIMENSION(:,:) ,POINTER :: flqc_sea
real ,DIMENSION(:,:) ,POINTER :: qgh_sea
real ,DIMENSION(:,:) ,POINTER :: psih_sea
real ,DIMENSION(:,:) ,POINTER :: rmol_sea
real ,DIMENSION(:,:) ,POINTER :: ust_sea
...
real ,DIMENSION(:,:) ,POINTER :: mf_at_base
...
real ,DIMENSION(:,:) ,POINTER :: composite_refl_10cm
real ,DIMENSION(:,:) ,POINTER :: refl_10cm_1km
real ,DIMENSION(:,:) ,POINTER :: refl_10cm_4km
...
integer ,DIMENSION(:,:) ,POINTER :: kbot_shallow
...
real ,DIMENSION(:,:) ,POINTER :: swddifc
...
real ,DIMENSION(:,:) ,POINTER :: swradmin
real ,DIMENSION(:,:) ,POINTER :: swradmax
real ,DIMENSION(:,:) ,POINTER :: tswradmin
real ,DIMENSION(:,:) ,POINTER :: tswradmax
real ,DIMENSION(:,:) ,POINTER :: swradmean
real ,DIMENSION(:,:) ,POINTER :: swradstd
real ,DIMENSION(:,:) ,POINTER :: swnormmin
real ,DIMENSION(:,:) ,POINTER :: swnormmax
real ,DIMENSION(:,:) ,POINTER :: tswnormmin
real ,DIMENSION(:,:) ,POINTER :: tswnormmax
real ,DIMENSION(:,:) ,POINTER :: swnormmean
real ,DIMENSION(:,:) ,POINTER :: swnormstd
...
real ,DIMENSION(:,:) ,POINTER :: albsol
real ,DIMENSION(:,:) ,POINTER :: albbcksol
...
real ,DIMENSION(:,:) ,POINTER :: rivermask
real ,DIMENSION(:,:) ,POINTER :: riverbedxy
real ,DIMENSION(:,:) ,POINTER :: nonriverxy
...
real ,DIMENSION(:,:) ,POINTER :: wspd10umax
real ,DIMENSION(:,:) ,POINTER :: wspd10vmax
real ,DIMENSION(:,:) ,POINTER :: wspd80max
real ,DIMENSION(:,:) ,POINTER :: wspd80umax
real ,DIMENSION(:,:) ,POINTER :: wspd80vmax
real ,DIMENSION(:,:) ,POINTER :: w_up_max
real ,DIMENSION(:,:) ,POINTER :: w_dn_max
real ,DIMENSION(:,:) ,POINTER :: refd_max
integer ,DIMENSION(:,:) ,POINTER :: refdm10c_calc
real ,DIMENSION(:,:) ,POINTER :: refdm10c_max
real ,DIMENSION(:,:) ,POINTER :: up_heli_max
real ,DIMENSION(:,:) ,POINTER :: up_heli_max16
real ,DIMENSION(:,:) ,POINTER :: up_heli_max02
real ,DIMENSION(:,:) ,POINTER :: up_heli_max03
real ,DIMENSION(:,:) ,POINTER :: up_heli_min
real ,DIMENSION(:,:) ,POINTER :: up_heli_min16
real ,DIMENSION(:,:) ,POINTER :: up_heli_min02
real ,DIMENSION(:,:) ,POINTER :: up_heli_min03
real ,DIMENSION(:,:,:) ,POINTER :: rel_vort
real ,DIMENSION(:,:,:) ,POINTER :: rlv
real ,DIMENSION(:,:,:) ,POINTER :: rlvn
real ,DIMENSION(:,:) ,POINTER :: rel_vort_max
real ,DIMENSION(:,:) ,POINTER :: rel_vort_max01
real ,DIMENSION(:,:) ,POINTER :: w_mean
real ,DIMENSION(:,:) ,POINTER :: w_mean_sum
real ,DIMENSION(:,:) ,POINTER :: grpl_max
real ,DIMENSION(:,:) ,POINTER :: ltg1_max
real ,DIMENSION(:,:) ,POINTER :: ltg2_max
real ,DIMENSION(:,:) ,POINTER :: ltg3_max
real ,DIMENSION(:,:) ,POINTER :: totice_colint
real ,DIMENSION(:,:) ,POINTER :: ltg1
real ,DIMENSION(:,:) ,POINTER :: ltg2
real ,DIMENSION(:,:) ,POINTER :: ltg3
integer ,DIMENSION(:,:) ,POINTER :: ltg1_calc
real ,DIMENSION(:,:) ,POINTER :: nci_ltg
real ,DIMENSION(:,:) ,POINTER :: nca_ltg
real ,DIMENSION(:,:) ,POINTER :: nci_w
real ,DIMENSION(:,:) ,POINTER :: nca_w
real ,DIMENSION(:,:) ,POINTER :: nci_wq
real ,DIMENSION(:,:) ,POINTER :: nca_wq
real ,DIMENSION(:,:) ,POINTER :: nci_refd
real ,DIMENSION(:,:) ,POINTER :: nca_refd
real ,DIMENSION(:,:) ,POINTER :: qr_max_ci
real ,DIMENSION(:,:) ,POINTER :: qg_max_ci
real ,DIMENSION(:,:) ,POINTER :: uh
real ,DIMENSION(:,:) ,POINTER :: uh16
real ,DIMENSION(:,:) ,POINTER :: uh02
real ,DIMENSION(:,:) ,POINTER :: uh03
...
real ,DIMENSION(:,:) ,POINTER :: maxcldfra
real ,DIMENSION(:,:) ,POINTER :: prec_acc_c
real ,DIMENSION(:,:) ,POINTER :: prec_acc_c1
real ,DIMENSION(:,:) ,POINTER :: prec_acc_nc
real ,DIMENSION(:,:) ,POINTER :: prec_acc_nc1
real ,DIMENSION(:,:) ,POINTER :: snow_acc_nc
real ,DIMENSION(:,:) ,POINTER :: snow_acc_nc1
real ,DIMENSION(:,:) ,POINTER :: graup_acc_nc
real ,DIMENSION(:,:) ,POINTER :: graup_acc_nc1
...
real ,DIMENSION(:,:) ,POINTER :: coef_bb_dc
real ,DIMENSION(:,:) ,POINTER :: fire_hist
real ,DIMENSION(:,:,:) ,POINTER :: aod3d_smoke
integer ,DIMENSION(:,:) ,POINTER :: min_fplume
integer ,DIMENSION(:,:) ,POINTER :: max_fplume
real ,DIMENSION(:,:) ,POINTER :: ddmass_smoke
real ,DIMENSION(:,:,:) ,POINTER :: smoke_gc
real ,DIMENSION(:,:,:) ,POINTER :: erod
real ,DIMENSION(:,:,:) ,POINTER :: cldfra2
real ,DIMENSION(:,:,:) ,POINTER :: rainprod
real ,DIMENSION(:,:,:) ,POINTER :: evapprod
...
real ,DIMENSION(:,:) ,POINTER :: mean_frp
real ,DIMENSION(:,:) ,POINTER :: std_frp
real ,DIMENSION(:,:) ,POINTER :: mean_fsize
real ,DIMENSION(:,:) ,POINTER :: std_fsize
real ,DIMENSION(:,:) ,POINTER :: ebb_smoke
real ,DIMENSION(:,:) ,POINTER :: flam_frac
real ,DIMENSION(:,:) ,POINTER :: peak_hr
real ,DIMENSION(:,:) ,POINTER :: lu_fire1
