...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % enh_vermix = model_config_rec % enh_vermix (grid%id)
 grid % bb_dcycle = model_config_rec % bb_dcycle (grid%id)
 grid % flam_part = model_config_rec % flam_part (grid%id)
 ...
 grid % lightning_opt = model_config_rec % lightning_opt (grid%id)
 grid % lightning_time_step = model_config_rec % lightning_time_step (grid%id)
 grid % temp_upper = model_config_rec % temp_upper (grid%id)
 grid % temp_lower = model_config_rec % temp_lower (grid%id)
 grid % n_ic = model_config_rec % n_ic (grid%id)
 grid % n_cg = model_config_rec % n_cg (grid%id)
 grid % passive_ltng = model_config_rec % passive_ltng (grid%id)
 grid % lflash_data = model_config_rec % lflash_data
 grid % flashrate_method = model_config_rec % flashrate_method (grid%id)
 ...
 grid % plumerise_flag = model_config_rec % plumerise_flag (grid%id)
 grid % debug_chem = model_config_rec % debug_chem (grid%id)
 grid % simple_dir_fdb = model_config_rec % simple_dir_fdb (grid%id)
 grid % simple_ind_fdb = model_config_rec % simple_ind_fdb (grid%id)
