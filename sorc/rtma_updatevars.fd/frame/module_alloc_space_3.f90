...
IF ( setinitval .EQ. 3 ) grid%alb_sol=0
...
IF ( setinitval .EQ. 3 ) grid%diff_6th_factor2=initial_data_value
...
IF ( setinitval .EQ. 3 ) grid%windfarm_ws=0
