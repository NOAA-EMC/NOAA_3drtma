MODULE module_sf_mynn_v34
  USE module_model_constants, only: &
       &p1000mb, cp, xlv, ep_2
  USE module_sf_sfclay, ONLY: sfclayinit
  USE module_bl_mynn_v34, only: tv0, mym_condensation
...
CONTAINS
  ...
  END SUBROUTINE mynn_sf_init_driver
   SUBROUTINE SFCLAY_mynn_v34(U3D,V3D,T3D,QV3D,P3D,dz8w, &
      ...
      ENDDO
    END SUBROUTINE SFCLAY_MYNN_V34
...
END SUBROUTINE SFCLAY1D_mynn
   ...
   SUBROUTINE Pan_etal_1994(PSIQ,PSIQ2,ustar,psih,psih2,KARMAN,Z1)
       ...
       REAL, PARAMETER :: XKA = 2.4E-5
         PSIQ =MAX(KARMAN*ZMUs/XKA + LOG((KARMAN*ustar*Z1)/XKA + &
              & Z1/ZL) - PSIH,2.0)
         PSIQ2=MAX(KARMAN*ZMUs/XKA + LOG((KARMAN*ustar*2.0)/XKA + &
              & 2./ZL) - PSIH2,2.0)
