...
END SUBROUTINE P3_INIT
 SUBROUTINE mp_p3_wrapper_wrf(th_3d,qv_3d,qc_3d,qr_3d,qnr_3d, &
  ...
  implicit none
   ...
   allocate (qitot(ims:ime, kms:kme,n_iceCat))
   allocate (qirim(ims:ime, kms:kme,n_iceCat))
   allocate (nitot(ims:ime, kms:kme,n_iceCat))
   allocate (birim(ims:ime, kms:kme,n_iceCat))
   allocate (diag_di(ims:ime, kms:kme,n_iceCat))
   allocate (diag_vmi(ims:ime, kms:kme,n_iceCat))
   allocate (diag_rhopo(ims:ime, kms:kme,n_iceCat))
   allocate (diag_effi(ims:ime, kms:kme,n_iceCat))
   log_predictNc=.false.
 ...
 real, intent(out), dimension(its:ite,kts:kte,nCat) :: diag_rhopo
