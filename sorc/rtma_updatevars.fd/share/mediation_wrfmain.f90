...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % reset_interval1 = model_config_rec % reset_interval1 (grid%id)
 ...
 grid % gsd_diagnostics = model_config_rec % gsd_diagnostics
 grid % wind_int = model_config_rec % wind_int
 grid % diag_int = model_config_rec % diag_int
 ...
 grid % alb_sol = model_config_rec % alb_sol (grid%id)
 ...
 grid % mp_tend_radar = model_config_rec % mp_tend_radar
 grid % mp_tend_lim = model_config_rec % mp_tend_lim
 grid % prec_acc_dt = model_config_rec % prec_acc_dt (grid%id)
 grid % prec_acc_dt1 = model_config_rec % prec_acc_dt1 (grid%id)
 ...
 grid % diff_6th_factor2 = model_config_rec % diff_6th_factor2 (grid%id)
 ...
 grid % windfarm_ws = model_config_rec % windfarm_ws
 ...
 grid % history_interval2 = model_config_rec % history_interval2 (grid%id)
 grid % history_interval_change = model_config_rec % history_interval_change (grid%id)
 ...
 grid % lmax_ideal = model_config_rec % lmax_ideal
 grid % kmax_ideal = model_config_rec % kmax_ideal
 grid % stepstoch = model_config_rec % stepstoch
 ...
 grid % mean_interval = model_config_rec % mean_interval
