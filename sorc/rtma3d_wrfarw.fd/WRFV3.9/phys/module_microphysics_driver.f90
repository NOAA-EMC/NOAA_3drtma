...
REAL, DIMENSION( ims:ime, kms:kme, jms:jme ), &
   ...
   LOGICAL, OPTIONAL :: f_qv,f_qc,f_qr,f_qi,f_qs,f_qg,f_qndrop,f_qni,f_qt &
                      ...
                      ,f_qnic,f_qnip,f_qnid &
                       ...
                       ,f_qir,f_qib &
                       ,f_qnwfa, f_qnifa
   INTEGER, INTENT(IN) :: spp_mp, kme_stoch
   REAL, DIMENSION(ims:ime,kms:kme_stoch,jms:jme), INTENT(IN), OPTIONAL:: pattern_spp_mp
