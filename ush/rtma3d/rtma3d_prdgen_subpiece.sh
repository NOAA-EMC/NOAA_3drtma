...
#                      .                                             .
# Script name:         rtma3d_prdgen_subpiece.sh
# Script description:  Run RTMA3D product generation job
#
...
# 2.5 km Lambert Conformal NDFD CONUS domain
gridspecs="lambert:265:25.0:25.0 238.445999:2145:2539.703 20.191999:1377:2539.703"
parmfile=${DATA}/conus_${leveltype}_${subpiece}.txt 
