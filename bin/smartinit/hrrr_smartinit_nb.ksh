...
${WGRIB2} hrrr_natgrd.tm00  -set_radius 1:6370000 -set_grib_type c3 -set_bitmap 1 -new_grid_winds grid -new_grid_interpolation neighbor -new_grid ${wgrib2def} hrrr.NDFDCSf${fhr}.grib2
