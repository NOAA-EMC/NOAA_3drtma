...
<!ENTITY RETRO_HOME "/lfs4/BMC/nrtrr/workflow/test_3drtma">

<!ENTITY SYSTEM_ID "RTMA3D"> 
<!ENTITY HOMEBASE_DIR "&RETRO_HOME;">
<!ENTITY DATABASE_DIR "&RETRO_HOME;/xml/retro">
<!ENTITY JOBNAME_PRE "RTMA3DGE">
<!ENTITY envir "esrl"> 
<!ENTITY KEEPDATA "YES">
...
<!ENTITY MACHINE    "jet">
<!ENTITY OBS_DIR "&RETRO_HOME;/xml/archive">
<!ENTITY HRRR_DIR "&RETRO_HOME;/xml/archive/hrrr">
...
<!ENTITY AIRCRAFT_REJECT "&RETRO_HOME;/xml/archive/amdar_reject_lists">
<!ENTITY SFCOBS_USELIST "&RETRO_HOME;/xml/archive//mesonet_uselists">
...
<!ENTITY BUFRLIGHTNING_DIR "/lfs4/BMC/rtwbl/mhu/rapobs/radiance">
...
<!ENTITY WALL_LIMIT_DA ''>
<!ENTITY WALL_LIMIT_PP ''>
<!ENTITY WALL_LIMIT_UV ''>
...
<!ENTITY COMMONVARS
   '<envar>
    ...
    <envar>
      <name>modulefile_jet</name>
      <value>&MODULE_NCO;</value>
    </envar>
    <envar>
      <name>machine</name>
      <value>&MACHINE;</value>
    ...
    <envar>
      <name>jlogfile</name>
      <value><cyclestr>&LOG_DIR;/@Y@m@d/jlogfile_@Y@m@d@H@M</cyclestr></value>
    </envar>
    <envar>
       <name>PDY</name>
    ...
    <envar>
       <name>subcyc</name>
       <value><cyclestr>-1</cyclestr></value>
    </envar>
    <envar>
      <name>KEEPDATA</name>
...
<workflow realtime="F" scheduler="&SCHEDULER;" cyclethrottle="30" cyclelifespan="01:00:00:00">

  <log>
    <cyclestr>&LOG_DIR;/@Y@m@d/workflow_@Y@m@d@H@M.log</cyclestr>
  </log>

  <cycledef group="all">00  22    07  02  2020 *</cycledef>
  ...
  <task name="obsprep_cloud" cycledefs="all" maxtries="3">
    ...
    <dependency>
      <or>
        ...
        <datadep><cyclestr>&LANGLEY_BUFR_DIR;/@Y@j@H00.rap_e.t@Hz.lgycld.tm00.bufr_d</cyclestr></datadep>
  ...
  <task name="obsprep_basic" cycledefs="all" maxtries="3">
    ...
    <dependency>
      <or>
        <and>
          <or>
            <datadep age="00:02:00"><cyclestr>&PREPBUFR_DIR;/@Y@j@H00.rap.t@Hz.prepbufr.tm00.@Y@m@d</cyclestr></datadep>
            <datadep age="00:02:00"><cyclestr>&PREPBUFR_DIR;/@Y@j@H00.rap_e.t@Hz.prepbufr.tm00.@Y@m@d</cyclestr></datadep>
          </or>
<!--for sub-hourly run
          <datadep age="00:02:00"><cyclestr>&PREPBUFR_DIR;/@Y@j@H@M.rtma_ru.t@H@Mz.prepbufr.tm00.@Y@m@d</cyclestr></datadep>
-->
        </and>
  ...
  <task name="gsianl" cycledefs="all" maxtries="3">
    ...
    <dependency>
      <and>
        <datadep age="00:06:00">&HRRR_DIR;/<cyclestr offset="-1:00:00">@Y@m@d@H</cyclestr>/wrfprd/<cyclestr>wrfout_d01_@Y-@m-@d_@H_00_00</cyclestr></datadep>
        <or> 
          <and>
