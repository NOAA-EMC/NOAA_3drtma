...
<!ENTITY ENVARS
   ...
   <envar>
        <name>COMINrap</name>
        <value>&COMINRAP;/rap.<cyclestr>@Y@m@d</cyclestr></value>
   </envar>
   <envar>
        <name>COMINhrrr</name>
        <value>&COMINHRRR;/hrrr.<cyclestr>@Y@m@d</cyclestr>/conus</value>
   </envar>
   <envar>
        <name>GESINhrrr</name>
        <value>&GESINHRRR;/hrrr/hrrrges_sfc/conus</value>
   </envar>
   <envar>
        <name>PROD_HEAD</name>
...
cat >> ${NWROOT}/xml/${RUN}_${expname}_rt.xml <<EOF 
  ...
  <task name="&NET;_plotgrads" cycledefs="02-11hr,01hr" maxtries="&maxtries;">
    &ENVARS;
    &PLOT_RESOURCES;
    &PLOT_RESERVATION;
    <envar>
